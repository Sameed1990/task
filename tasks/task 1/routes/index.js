...
router.get('/tags' , async (req , res) =>{
  const fetch = await tagModel.find({});
  // console.log("Fetch Tags" , fetch);
  res.json({Data : fetch})
})
...
router.get('/Enums' , async (req , res) =>{
  const fetch = await EnumModel.find({});
  // console.log("Fetch Tags" , fetch);
  res.json({Enums : fetch})
})
...
router.get('/Weights' , async (req , res) =>{
  const fetch = await WeightModel.find({});
  // console.log("Fetch Tags" , fetch);
  res.json({Weight : fetch})
})
...
router.get('/Products-units' , async (req , res) =>{
...
router.get('/Products-weights' , async (req , res) =>{
  const fetch = await ProductWeightModel.find({});
  // console.log("Fetch Tags" , fetch);
  res.json({Weight : fetch})
})
